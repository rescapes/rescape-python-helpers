...
from rescape_python_helpers import ewkt_from_feature, geometry_from_feature, geometrycollection_from_featurecollection
...
class GeometryHelepersTest(TestCase):
    ...
    def test_geometry_collection_from_feature_collection(self):
        result = geometrycollection_from_featurecollection({
